...
FORM "client_31", "gut_se_30.client_31";
...
TAG:  		{2                }
"
FORM "client_30", "gut_se_30.client_30";
...
TAG6: 	{12                              }
"
FORM "plc_viewer", "gut_se_30.plc_viewer";
...
FORM "m340", "gut_se_30.m340";
1: "Tag", 32, readwrite,  "Equipment", "NAME","TYPE=GUT_SYSTEM";
...
IP Adresse:	{2                  }
 "
FORM "m340_redundant", "gut_se_30.m340_redundant";
1: "Tag", 32, readwrite,  "Equipment", "NAME","TYPE=GUT_SYSTEM";
2: "EA", 32, readwrite_foreign, "IO Devices", "ADDR";
...
IP Adresse:	{2                  }
 "
FORM "m580_redundant", "gut_se_30.m358_redundant";
1: "Tag", 32, readwrite,  "Equipment", "NAME","TYPE=GUT_SYSTEM";
2: "EA", 32, readwrite_foreign, "IO Devices", "ADDR";
5: "EA2", 32, readwrite_foreign, "IO Devices", "ADDR";
3: "IOName", 32, readwrite_foreign, "IO Devices", "PORT";
...
FORM "Quantum", "gut_se_30.quantum";
1: "Tag", 32, readwrite,  "Equipment", "NAME","TYPE=GUT_SYSTEM";
2: "EA", 32, readwrite_foreign, "IO Devices", "ADDR";
3: "IOName", 32, readwrite_foreign, "IO Devices", "PORT";
4: "IONummer", 32, readwrite_foreign, "IO Devices", "NUMBER";
...
FORM "quantum_redundant", "gut_se_30.quantum_redundant";
1: "Tag", 32, readwrite,  "Equipment", "NAME","TYPE=GUT_SYSTEM";
...
IP Adresse NOE:	{5                  }
 "
FORM "device_run", "gut_se_30.device_run";
1: "Tag", 64, readwrite;
...
Variable (TAG):	{1                                 }
"
FORM "device_run2", "gut_se_30.device_run2";
1: "Tag", 64, readwrite;
