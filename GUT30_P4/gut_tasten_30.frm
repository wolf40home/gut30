FORM "checkbox", "gut_tasten_30.checkbox";
...
Bit Nr.:	{2   }
"
FORM "checkbox_01", "gut_tasten_30.checkbox_01";
1: "Tag", 32, readwrite, "Variable Tags|Local Variable", "NAME";
2: "BitNr", 3, readwrite;
3: "Text", 16, readwrite;
4: "Tagt", 32, readwrite;
...
Bit Nr.:	{2   }
"
FORM "checkbox_03", "gut_tasten_30.checkbox_03";
1: "Tag", 32, readwrite, "Variable Tags|Local Variable", "NAME";
2: "BitNr", 3, readwrite;
3: "Text", 16, readwrite;
...
FORM "Bildanwahl_2_Zeilen", "gut_tasten_30.Bildanwahl_2_Zeilen";
...
Bildname:	{3                              }
"
FORM "bildanwahl_2_zeilen_klei", "gut_tasten_30.bildanwahl_2_zeilen_klei";
1: "Text1", 18, readwrite;
2: "Text2", 18, readwrite;
3: "Bildname", 64,  readwrite, "Pages", "NAME";
...
Bildname:	{3                              }
"
FORM "trend_popup21", "gut_tasten_30.trend_popup21";
...
FORM "trend_popup22", "gut_tasten_30.trend_popup22";
1: "pen1", 32, readwrite_foreign, "Trend Tags", "NAME";
2: "pen2", 32, readwrite_foreign, "Trend Tags", "NAME";
3: "pen3", 32, readwrite_foreign, "Trend Tags", "NAME";
...
FORM "trend_popup", "gut_tasten_30.trend_popup";
1: "pen1", 32, readwrite_foreign, "Trend Tags", "NAME";
2: "pen2", 32, readwrite_foreign, "Trend Tags", "NAME";
3: "pen3", 32, readwrite_foreign, "Trend Tags", "NAME";
...
FORM "admintaste", "gut_tasten_30.admintaste";
...
Funktion 2:	{5                                                          }
"
FORM "alarmtaste", "gut_tasten_30.alarmtaste";
