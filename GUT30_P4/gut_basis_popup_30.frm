FORM "help", "gut_basis_popup_30.help";
1: "Page", 8, readwrite;
...
Hilfe Datei:	{2                                 }
"
FORM "seiten", "gut_basis_popup_30.seiten";
1: "Symb", 10, readwrite;
2: "Seit", 3, readwrite;
3: "Tooltip", 48, readwrite;
4: "unsichtbar", 30, readwrite;
NORMAL
"Genie - Menuelement
...
Unsichtbar	{4                       }
"
FORM "led_ein_aus", "gut_basis_popup_30.led_ein_aus";
1: "ASSW", 3, readwrite;
2: "BitNR", 3, readwrite;
...
Bit Nr.:	{2    }
"
FORM "led_rot_gruen", "gut_basis_popup_30.led_rot_gruen";
1: "ASSW", 3, readwrite;
2: "BitNR", 3, readwrite;
...
Bit Nr.:	{2    }
"
FORM "led_error", "gut_basis_popup_30.led_error";
...
FORM "Pfeil_L_gw290", "gut_basis_popup_30.Pfeil_L_gw290";
1: "TYP", 8, readwrite;
...
FORM "Pfeil_L_gw210", "gut_basis_popup_30.Pfeil_L_gw210";
1: "TYP", 8, readwrite;
2: "TYPbit", 8, readwrite;
3: "TipTEXT", 32, readwrite;
4: "WERTAss", 8, readwrite;
...
FORM "pfeil_0_gw290", "gut_basis_popup_30.Pfeil_O_gw290";
...
Position: (0 -3)	  	{10  }
"
FORM "pfeil_0_gw210", "gut_basis_popup_30.Pfeil_O_gw210";
1: "TYPass", 8, readwrite;
2: "TYPbit", 8, readwrite;
3: "TipTEXT", 32, readwrite;
4: "WERTAss", 8, readwrite;
...
"FORM "pfeil_u_gw290", "gut_basis_popup_30.pfeil_u_gw290";
1: "TYPass", 8, readwrite;
2: "TYPbit", 8, readwrite;
3: "TipTEXT", 32, readwrite;
4: "WERTAss", 8, readwrite;
...
"FORM "Pfeil_U_gw210", "gut_basis_popup_30.Pfeil_u_gw210";
1: "TYPass", 8, readwrite;
2: "TYPbit", 8, readwrite;
3: "TipTEXT", 32, readwrite;
4: "WERTAss", 8, readwrite;
...
FORM "kopf", "gut_basis_popup_30.kopf";
1: "NRl", 8, readwrite;
2: "NRr", 8, readwrite;
3: "bl", 8, readwrite;
4: "BR", 8, readwrite;
...
ID für LW:	{5         }  Modus {6         }  
"
FORM "kopf_oTyp", "gut_basis_popup_30.kopf_oTyp";
1: "NRl", 8, readwrite;
2: "bl", 8, readwrite;
3: "NRM", 8, readwrite;
4: "BM", 8, readwrite;
...
ID für LW:	{3         }  Modus {4         } 
"
FORM "kopf_3", "gut_basis_popup_30.kopf_3";
1: "NRl", 8, readwrite;
2: "NRr", 8, readwrite;
3: "bl", 8, readwrite;
4: "BR", 8, readwrite;
...
FORM "wert_mit_text", "gut_basis_popup_30.wert_mit_text";
...
FORM "text_meldung", "gut_basis_popup_30.text_meldung";
1: "M", 4, readwrite;
...
Farbe:		{3                 }
"
FORM "text_meldungk", "gut_basis_popup_30.text_meldungk";
1: "M", 4, readwrite;
2: "Mtext", 32, readwrite;
3: "Farbe", 32, readwrite, "Labels", "EXPR","NAME=_Farbe*";
4: "Mbit", 4, readwrite;
...
FORM "text_meldung_sichtbar", "gut_basis_popup_30.text_meldung_sichtbar";
1: "M", 4, readwrite;
2: "Mtext", 32, readwrite;
3: "Farbe", 32, readwrite, "Labels", "EXPR","NAME=_Farbe*";
4: "Mbit", 4, readwrite;
...
Alarmtext:	{2                              }
Farbe:		{3                 }"
FORM "text_meldung2", "gut_basis_popup_30.text_meldung2";
1: "M", 4, readwrite;
2: "Mtext", 32, readwrite;
3: "Farbe", 32, readwrite, "Labels", "EXPR","NAME=_Farbe*";
4: "Mbit", 4, readwrite;
...
FORM "wert_text", "gut_basis_popup_30.wert_text";
1: "Wert", 4, readwrite;
2: "Bez", 4, readwrite;
3: "Farbe", 32, readwrite, "Labels", "EXPR","NAME=_Farbe*";
4: "MODE", 4, readwrite;
...
FORM "wert_text_frg", "gut_basis_popup_30.wert_text_frg";
1: "Wert", 4, readwrite;
2: "Bez", 4, readwrite;
3: "Farbe", 32, readwrite, "Labels", "EXPR","NAME=_Farbe*";
4: "MODE", 4, readwrite;
...
"
FORM "wert_text_107", "gut_basis_popup_30.wert_text_107";
1: "Wert", 4, readwrite;
2: "Bez", 4, readwrite;
3: "Farbe", 32, readwrite, "Labels", "EXPR","NAME=_Farbe*";
4: "MAss",4, readwrite;
...
FORM "wert_107", "gut_basis_popup_30.wert_107";
1: "Wert", 4, readwrite;
2: "Farbe", 32, readwrite, "Labels", "EXPR","NAME=_Farbe*";
3: "MAss",4, readwrite;
...
Farbe:		{2                      }
"
FORM "ueber_klein", "gut_basis_popup_30.ueber_klein";
1: "Seite", 3, readwrite;
...
Seite:		{1   }
"
FORM "ueber", "gut_basis_popup_30.ueber";
1: "Seite", 3, readwrite;
...
Seite:	{1   }
"
FORM "asm_bit", "gut_basis_popup_30.asm_bit";
...
FORM "interlock", "gut_basis_popup_30.interlock";
