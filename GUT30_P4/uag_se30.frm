...
FORM "client_2nw_30", "uag_se30.client_2nw_30";
...
FORM "client_31", "uag_se30.client_31";
...
TAG:  		{2                }
"
FORM "client_30", "uag_se30.client_30";
...
TAG6: 	{12                              }
"
FORM "plc_viewer", "uag_se30.plc_viewer";
...
{Line, 100}
Variable (TAG):	{1                                 }"
FORM "ispy101s", "uag_se30.ispy101s";
1: "Tag", 32, readwrite, "Variable Tags|Local Variable", "NAME","*_GAIN";
2: "Tag2", 32, readwrite, "Variable Tags|Local Variable", "NAME","*_AHHein";
NORMAL
...
Grenzwert(TAG):	{2                                 }
"
FORM "ispy101w", "uag_se30.ispy101w";
1: "Tag", 32, readwrite, "Variable Tags|Local Variable", "NAME","*_GAIN";
2: "Tag2", 32, readwrite, "Variable Tags|Local Variable", "NAME","*_AHHein";
NORMAL
"Genie - Analog Eingang ISPY
...
IP Adresse:	{2                  }
 "
FORM "m340_redundant", "uag_se30.m340_redundant";
1: "Tag", 32, readwrite, "Variable Tags|Local Variable", "NAME","*_HMISW\1";
2: "EA", 32, readwrite_foreign, "IO Devices", "ADDR";
...
IP Adresse:	{2                  }
 "
FORM "m580_redundant", "uag_se30.m358_redundant";
1: "Tag", 32, readwrite, "Variable Tags|Local Variable", "NAME","*_HMISW\1";
2: "EA", 32, readwrite_foreign, "IO Devices", "ADDR";
5: "EA2", 32, readwrite_foreign, "IO Devices", "ADDR";
3: "IOName", 32, readwrite_foreign, "IO Devices", "NAME";
...
FORM "quantum_redundant", "uag_se30.quantum_redundant";
1: "Tag", 32, readwrite, "Variable Tags|Local Variable", "NAME","*_HMISW\1";
2: "EA", 32, readwrite, "IO Devices", "ADDR";
3: "IOName", 32, readwrite, "IO Devices", "NAME";
...
IP Adresse NOE:	{5                  }
 "
FORM "device_run", "uag_se30.device_run";
1: "Tag", 64, readwrite;
...
Variable (TAG):	{1                                 }
"
FORM "device_run2", "uag_se30.device_run2";
1: "Tag", 64, readwrite;
