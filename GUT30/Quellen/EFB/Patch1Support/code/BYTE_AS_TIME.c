...
// Filename	: BYTE_AS_TIME.c
// EF		: BYTE_AS_TIME
// Version	: 11.0
// Author	: 2017 Steiner

/*
Converst four BYTEs to a TIME.
Use to convert four BYTEs to a value of type TIME. Input pin BYTE1 becomes the lowest part of the DATE value and pin BYTE4 becomes the highest part of the DATE value.
*/

#include "BYTE_AS_TIME.h"
...
IECBool fb_call_model BYTE_AS_TIME(
	...
	IEC_PARAM_RTE_OFFSET OUT          // RETURNED VALUE - Output of type TIME consisting of the four input BYTEs.
)
//}} SDKC_PROTOTYPE_END
{
	// TODO : Write here variables declarations.
    IECTime *pOut;
	st_byte_time_array tmp;
